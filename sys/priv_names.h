 ...
 */
#define	PRIV_FILE_READ		((const char *)"file_read")
 ...
 */
#define	PRIV_FILE_WRITE		((const char *)"file_write")
 ...
 */
#define	PRIV_NET_ACCESS		((const char *)"net_access")
 ...
 * with Trusted Extensions.
 */
#define	PRIV_NET_MAC_IMPLICIT	((const char *)"net_mac_implicit")
 ...
 */
#define	PRIV_SYS_IPTUN_CONFIG	((const char *)"sys_iptun_config")
 ...
 */
#define	PRIV_SYS_PPP_CONFIG	((const char *)"sys_ppp_config")

/*
 * Allows a process to bind processes to processor sets.
 */
#define	PRIV_SYS_RES_BIND	((const char *)"sys_res_bind")
